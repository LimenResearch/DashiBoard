...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      class="inline-flex h-7 items-center rounded-sm px-2 text-xs text-primary-foreground/80 transition-colors hover:bg-primary-foreground/10 hover:text-primary-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
    >
      {themeMode() === "dark" ? "☀" : "☾"}
    </button>
  );
