  ...
  return (
    <div>
      <div class="flex items-center border-b-2 border-border">
        <button
          type="button"
          class="w-full flex-1 px-2 py-1.5 text-left text-xs font-semibold text-primary hover:bg-secondary"
        ...
        <Show when={props.modified}>
          <button
            ...
            class="px-2 py-1.5 text-xs text-muted-foreground hover:text-destructive"
