...
const CARD_TYPES = Dict(
    "split" => SplitCard,
    "rescale" => RescaleCard,
    "dimensionality_reduction" => DimensionalityReductionCard,
    "cluster" => ClusterCard,
    "glm" => GLMCard,
    "interp" => InterpCard,
...
function card_configurations(;
    ...
    d = Dict(
        ...
        "dimensionality_reduction" => parsefile(config_path("dimensionality_reduction.toml")),
    ...
    return [
        ...
        card_widget(d, "dimensionality_reduction"; dimensionality_reduction...),
